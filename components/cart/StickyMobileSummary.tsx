      ...
      <div className='flex justify-between gap-8 items-center px-4'>
        <div>
          <div className='flex  flex-col text-base'>
            <span className='font-syne font-medium text-sm'>Totalsumma:</span>
            <span className='font-medium text-base'>{formatPrice(totalPrice)}</span>
          </div>
        </div>
        <Link
          href='/checkout'
          ...
          className='mt-2 w-1/2  h-11 text-sm lg:text-base font-semibold'
        >
        Till kassan
      </Link>
      </div>
